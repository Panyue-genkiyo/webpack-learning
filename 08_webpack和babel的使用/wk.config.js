...
module.exports = {
    ...
    module:{
        rules:[
            {
                test:/\.jsx?$/,
                exclude: [/node-modules/, /core-js/], //意味着在node_module里的包是不使用下面babel-loader的
                use:{
                    loader: "babel-loader",
                    // options:{
                    //     presets: [
                    //         "@babel/preset-env" //根据browserslist 并使用babel生成目标javascript代码
                    //         //['@babel/preset-env', { targets: { browsers: ['> 1%', 'not dead'] } }] //这里的优先级更高的
                    //     ],
                    //     // plugins:[
